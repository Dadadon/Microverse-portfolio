...
const portfolioCards = [
  ...
  {
    key: "c2",
    imagem: "src/dadadon.github.io_To-Do-List_.png",
    imageo: "src/Screenshot_To Do List - Chromium_3.png",
    popImgd: "src/Screenshot_To Do List - Chromium_3.png",
    name: "Todo List",
    exp: ["MICROVERSE", "•", "Full Stack Dev", "•", "2022"],
    expm: ["MICROVERSE", "•", "Full Stack Dev", "•", "2022"],
    technologies: ["CSS", "JavaScript", "html"],
    technologiesm: ["CSS", "JavaScript", "html"],
    description:
      "Todo list project that allows users to add, remove, edit, and update the status of tasks stored in local storage",
    button: "See Project",
    links: [
      "https://github.com/Dadadon/To-Do-List",
      "https://dadadon.github.io/To-Do-List/",
    ],
  },
  {
    key: "c3",
    image: "src/Snapshoot_Portfoliod3.png",
  ...
  },
  {
    ...
    imagem: "src/Snapshoot_Portfolio(4).png",
